...
object NamedAndDefaultArguments_v3 extends App {
  val readFinanceData = () => {
...
//  println(getStockPriceDetails(date = "12-06-2020", ticker = "BNS", priceType = "close"))

//  println(getStockPriceDetails("12-06-2020", "BNS", "close"))
